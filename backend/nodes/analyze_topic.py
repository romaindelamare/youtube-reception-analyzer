...
PROMPT = ChatPromptTemplate.from_messages([
    ("system", (
        ...
        "Focus EXCLUSIVELY on the SUBJECT/TOPIC ITSELF:\n"
        "- Factual accuracy or inaccuracy about the topic\n"
        "- What's true, false, or missing from the subject matter\n"
        "- Gaps, omissions, or important information in the real world / field / reality\n"
        "- Viewer's expert knowledge or corrections about the subject (not about the video)\n"
        "- Biases, perspectives, or context about the topic itself\n"
        "- Viewer's reactions to the subject matter (whether it's important, interesting, relevant)\n"
        "- Limitations or gaps in the field/subject itself\n\n"
        "EXPLICITLY IGNORE AND EXCLUDE:\n"
        "- Video quality, editing, pacing, length, or production issues\n"
        "- Creator's presentation style, clarity, tone, or teaching ability\n"
        "- Sponsorships, ads, or monetization\n"
        "- Whether the creator explained things well or poorly\n"
        "- Any criticism about how the creator presented or delivered the content\n"
        "- Production choices or format feedback\n\n"
        "Return a JSON object with:\n"
        "- sentiments: list of 'positive', 'neutral', or 'negative' — one per comment, in order, "
        "based on how the viewer feels about the TOPIC/SUBJECT (not the video/creator)\n"
